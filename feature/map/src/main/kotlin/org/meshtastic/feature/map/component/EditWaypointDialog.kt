        ...
        AlertDialog(
            ...
            text = {
                Column(modifier = modifier.fillMaxWidth()) {
                    ...
                    PlaceTypeEmojiRow { codePoint ->
                        waypointInput = waypointInput.copy { icon = codePoint }
                    }
                    EditTextPreference(
...
private data class PlaceTypePreset(val emoji: String, val label: String, val codePoint: Int)

@Suppress("MagicNumber")
private val PLACE_TYPE_PRESETS = listOf(
    PlaceTypePreset("\uD83D\uDCCD", "Pin",     128205),
    PlaceTypePreset("\uD83C\uDFE5", "Hospital",127973),
    PlaceTypePreset("\uD83D\uDE93", "Police",  128659),
    PlaceTypePreset("\uD83D\uDE92", "Fire",    128658),
    PlaceTypePreset("\uD83C\uDF7D", "Food",    127869),
    PlaceTypePreset("\u26FA",       "Camp",    9978),
    PlaceTypePreset("\uD83C\uDFEB", "School",  127979),
    PlaceTypePreset("\u26A0\uFE0F", "Hazard",  9888),
    PlaceTypePreset("\u2705",       "Safe",    9989),
    PlaceTypePreset("\uD83D\uDCA7", "Water",   128167),
    PlaceTypePreset("\u26FD",       "Fuel",    9981),
    PlaceTypePreset("\uD83D\uDD27", "Supply",  128295),
)

@OptIn(ExperimentalLayoutApi::class)
@Composable
private fun PlaceTypeEmojiRow(onPicked: (Int) -> Unit) {
    FlowRow(
        modifier = Modifier.fillMaxWidth().padding(bottom = 8.dp),
        horizontalArrangement = Arrangement.spacedBy(4.dp),
        verticalArrangement = Arrangement.Center,
    ) {
        PLACE_TYPE_PRESETS.forEach { preset ->
            Text(
                text = preset.emoji,
                fontSize = 24.sp,
                modifier = Modifier
                    .background(MaterialTheme.colorScheme.surfaceVariant, RoundedCornerShape(6.dp))
                    .clickable { onPicked(preset.codePoint) }
                    .padding(6.dp),
            )
        }
    }
